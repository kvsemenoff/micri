...
<section class="footer">
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-12 col-xs-12">   <!-- col-xs-push-6 -->
             ...
             <div class="col-md-3 col-sm-12 col-xs-12">
				<ul class="aa-footer-soclist">
					<li class="aa-footer-soclist__item"><a href="#"><img src="img/fac.png" alt="fac.png"></a></li>
					<li class="aa-footer-soclist__item"><a href="#"><img src="img/twit.png" alt="twit.png"></a></li>
					<li class="aa-footer-soclist__item"><a href="#"><img src="img/vk.png" alt="vk.png"></a></li>
				</ul>
            </div>
        </div>
    </div>
